...
Resource keys for TimePicker follow the pattern `TimePicker{Property}{State}`:

```
TimePickerBackground
TimePickerBorderBrush
TimePickerForeground
TimePickerPointeroverBorderBrush
TimePickerFocusBorderBrush
TimePickerDisabledBackground
TimePickerSelectorBackground
TimePickerSelectorPointeroverBackground
TimePickerSelectorPressedBackground
TimePickerSelectorForeground
TimePickerWatermarkForeground
...
```
