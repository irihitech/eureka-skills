...
Resource keys for DatePicker follow the pattern `DatePicker{Property}{State}`:

```
DatePickerBackground
DatePickerBorderBrush
DatePickerForeground
DatePickerPointeroverBorderBrush
DatePickerFocusBorderBrush
DatePickerDisabledBackground
DatePickerSelectorBackground
DatePickerSelectorPointeroverBackground
DatePickerSelectorPressedBackground
DatePickerSelectorForeground
DatePickerWatermarkForeground
...
```
