...
Resource keys follow the convention `CalendarDatePicker{Property}{State}`:

```
CalendarDatePickerBackground
CalendarDatePickerBorderBrush
CalendarDatePickerForeground
CalendarDatePickerPointeroverBorderBrush
CalendarDatePickerFocusBorderBrush
CalendarDatePickerDisabledBackground
CalendarDatePickerWatermarkForeground
CalendarDatePickerButtonBackground
CalendarDatePickerButtonPointeroverBackground
CalendarDatePickerButtonPressedBackground
CalendarDatePickerButtonForeground
CalendarDatePickerDropDownBackground
CalendarDatePickerDropDownBorderBrush
...
```
